...
export const Route = createFileRoute('/painelAdmin')({
  beforeLoad: async () => {
    ...
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/autenticar/verificar/admin`, {
...
function PainelAdmin() {
  ...
  const fetchUtilizadores = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/autenticar`, { withCredentials: true });
  ...
  const promoverUtilizador = async (idUtilizador) => {
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/gestor`, { ID_Utilizador: idUtilizador }, { withCredentials: true });
  ...
  const despromoverGestor = async () => {
    ...
    try {
      ...
      await axios.delete(`${import.meta.env.VITE_API_URL}/api/gestor/${gestorToDespromover.ID_Utilizador}`, { withCredentials: true });
      fetchUtilizadores();
      setShowModal(false);
    } catch (err) {
